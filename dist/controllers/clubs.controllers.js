...
exports.getPosts = exports.addPostToCLub = exports.getClub = exports.getClubs = void 0;
...
exports.addPostToCLub = async_1.default(async (req, res, next) => {
    ...
    const { id } = await post_1.default.create(req.body);
...
//# sourceMappingURL=clubs.controllers.js.map